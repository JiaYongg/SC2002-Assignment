...
public class HDBManagerView {
    ...
    private void editProjectMenu() {
        ...
        try {
            ...
            // Application dates
            System.out.print("Application opening date [" + dateFormat.format(selectedProject.getApplicationOpenDate()) + "]: ");
            ...
            int newOfficerSlots = officerSlotsStr.isEmpty() ? 
                                selectedProject.getOfficerSlots() : 
        ...
        try {
            ...
            if (success) {
                ...
                if (newVisibility) {
                    ...
                    System.out.println("Applicants will not be able to see or apply for this project until you make it visible again.");
                }
            } else {
